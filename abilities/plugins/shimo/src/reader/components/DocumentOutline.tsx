...
export function DocumentOutline({
  ...
  return (
    <div className="absolute right-4 top-4 z-20 flex w-72 flex-col rounded-2xl border border-border/60 bg-background/95 p-4 shadow-xl backdrop-blur-md animate-in fade-in zoom-in-95 duration-150 sm:right-6">
                ...
                return (
                  <li key={heading.id}>
                    <Button
                      ...
                      className={`h-auto w-full justify-start gap-1.5 rounded-lg py-1.5 pr-2 text-left text-xs transition-colors hover:bg-muted/70 hover:text-foreground ${indentClass}`}
                    >
