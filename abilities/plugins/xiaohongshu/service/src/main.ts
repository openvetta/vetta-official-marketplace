...
async function route(request: IncomingMessage, response: ServerResponse): Promise<void> {
	...
	if (request.method === "POST" && url.pathname === "/mcp") {
		...
		if (rpc.method === "initialize") return json(response, 200, { jsonrpc: "2.0", id, result: { protocolVersion: "2024-11-05", capabilities: { tools: {} }, serverInfo: { name: "xiaohongshu", version: "1.1.0" } } });
